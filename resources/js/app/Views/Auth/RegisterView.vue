   ...
   <AuthLayout>
     <div class="mt-20 rounded-lg max-w-xl mx-auto p-4 border border-gray-100 shadow">
        <form @submit.prevent="register" class="max-w-xl mx-auto">
            <h3 class="text-center font-semibold text-xl my-5 uppercase">Register a new account</h3>
            ...
            <button type="submit"
             ...
             <div class="text-center font-serif my-3">
               Already have an account <RouterLink to="/login" class="text-blue-600 hover:underline">login</RouterLink> here.
            </div>
        </form>
    </div>
   </AuthLayout>
