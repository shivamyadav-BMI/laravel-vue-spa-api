        ...
        <div class="p-4 w-full">
            ...
            <div class="relative overflow-x-auto shadow-md sm:rounded-lg my-10">
                <table class="w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                    ...
                    <tbody>
                        <tr v-for="category in store.categories.data"
                            ...
                            <td class="px-6 py-4 space-x-3">
                                ...
                                <button class="cursor-pointer text-red-500" @click="openModal(category.id)">Delete</button>
                            </td>
                        </tr>
            ...
            <!-- <Pagination :pagination="store.roles" /> -->
             <!-- pagination -->
            <Pagination :pagination="store.categories" :fetch="store.fetchAll"/>
...
// delete role
const handleDelete = () => {
    store.categoryDelete(CategoryId.value);
    store.categories.data.splice(CategoryId,1);
    closeModal();
}
</script>
